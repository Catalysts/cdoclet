package cc.catalysts.asdoclet.generator;
...
import cc.catalysts.asdoclet.generator.velocity.ClassDescriptor;
import cc.catalysts.asdoclet.generator.velocity.EnumDescriptor;
import cc.catalysts.asdoclet.generator.velocity.FieldDescriptor;
import cc.catalysts.asdoclet.generator.velocity.InterfaceDescriptor;
import cc.catalysts.asdoclet.generator.velocity.MethodDescriptor;
import cc.catalysts.asdoclet.generator.velocity.ParameterDescriptor;
import cc.catalysts.asdoclet.generator.velocity.PropertyDescriptor;
import cc.catalysts.asdoclet.generator.velocity.ProxyDescriptor;
import cc.catalysts.asdoclet.generator.velocity.TypeDescriptor;
...
public class VelocityGenerator implements Generator {
	...
	public VelocityGenerator(String destination, String namespace, String language, Class<? extends Annotation> enumAnnotation, TypeMap typeMap, TypeMap annotationTypeMap, TypeMap annotationMap) throws Exception {
		...
		Velocity.setProperty(Velocity.RUNTIME_LOG_LOGSYSTEM_CLASS, "org.fluffnstuff.asdoclet.generator.velocity.SLF4JLogChute");
...
// --------------------- Interface Generator ---------------------
	...
	public void endMethod(Type callbackType) {
		if (callbackType != cc.catalysts.asdoclet.generator.Type.EMPTY) {
