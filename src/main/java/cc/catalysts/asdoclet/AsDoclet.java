...
import cc.catalysts.asdoclet.generator.AsGenerator;
import cc.catalysts.asdoclet.generator.Generator;
import cc.catalysts.asdoclet.generator.VelocityGenerator;
import cc.catalysts.asdoclet.handler.ClassHandler;
import cc.catalysts.asdoclet.handler.EnumHandler;
import cc.catalysts.asdoclet.handler.Handler;
import cc.catalysts.asdoclet.handler.InterfaceHandler;
import cc.catalysts.asdoclet.handler.TagParser;
import cc.catalysts.asdoclet.map.ClassTypeMap;
...
public class AsDoclet {
	...
	private static final Logger logger = LoggerFactory.getLogger(AsDoclet.class);

	static {
		try {
			URL config = AsDoclet.class.getResource("logback-test.xml");
			if (config == null) config = AsDoclet.class.getResource("logback.xml");
